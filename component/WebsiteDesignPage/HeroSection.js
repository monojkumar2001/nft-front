          ...
          <section className={Styles.hero}>
            ...
            >
              ...
              <p className="raleway-black-16">
                If you&apos;re looking for fantastic
                website Design solutions, fintech or nft websites is off limits
                with our team of multidisciplinary experts.
              </p>

              <div className="hero-btns">
                <button className={Styles.btn_hero_1}>
                  <Link href="#web-design">Get Started</Link>
                </button>
              </div>
            </div>
